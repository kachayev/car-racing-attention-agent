...
class CarRacingAgent(nn.Module):
    ...
    def step(self, obs):
        ...
        return centers.numpy(), None

    def reset(self):
        self.controller.reset()


class Exp4Agent(nn.Module):
...
def parse_args():
    ...
    parser.add_argument("--logs-dir", type=str, default="es_logs/exp4_topK_stack_cmaes_v0")
